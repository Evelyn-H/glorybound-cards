...
\bettertextbox
    [y=4.5mm, width=54mm, height=7mm, fontsize=14pt, font=\titlefont\bfseries]
...
\bettertextbox
    [y=12mm, width=54mm, height=5mm, font=\titlefont\sbseries]
    [valign=centerline]
{%
    Basic Permanent
}
...
\bettertextbox
    [y=17.5mm, width=54mm, height=64mm]
...
\bettertextbox
    [y=81.5mm, width=27mm, height=4mm, anchor=north east, font=\titlefont\color{white}, fontsize=7pt, margin=0.5mm]
...
\bettertextbox
    [y=81.5mm, x=0mm, width=27mm, height=4mm, anchor=north west, font=\titlefont\color{white}, fontsize=7pt, margin=0.5mm]
