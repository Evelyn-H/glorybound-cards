...
\pgfkeys{/card/.cd,% set the initial path
    ...
    starter/.code={\pgfkeyssetvalue{starter}{#1}},
    inspiration/.code={\pgfkeyssetvalue{inspiration}{#1}},
    ascension/.code={\pgfkeyssetvalue{ascension}{#1}},
    linked/.code={\pgfkeyssetvalue{linked}{#1}},
    linked type/.initial={},
    linked short/.code={\pgfkeyssetvalue{linked short}{#1}},%
    item/.code={\pgfkeyssetvalue{item}{#1}},
    token/.code={\pgfkeyssetvalue{token}{#1}},
    support/.code={\pgfkeyssetvalue{support}{#1}},
    domain/.code={\pgfkeyssetvalue{domain}{#1}},
    % affinities
    ...
    type/.initial={%
        \printsepifnotempty{%
            \pgfkeysifdefined{linked}{Conjured Move}{%
                \pgfkeysifdefined{item}{Item}{%
                    \pgfkeysifdefined{token}{Token}{%
                        \pgfkeysifdefined{inspiration}{Inspiration}{%
                            \pgfkeysifdefined{ascension}{Ascension}{%
                                \pgfkeysifdefined{starter}{Starter Move}{Move}%
                            }%
                        }%
                    }%
                }%
...
\let\domainprimary\@empty
\let\domainsecondary\@empty
\makeatother
...
\NewDocumentCommand{\card}{ +O{} }{
    ...
    % \pgfkeysifdefined{domain}{%
    %     \pgfkeys{/card/.cd,
    %         color-left=\domainprimary,
    %         color-right=\domainsecondary,
    %     }
    %     \definecolor{primary}{HTML}{\domainprimary}
    %     \definecolor{secondary}{HTML}{\domainsecondary}
    % }{%
    ...
    \getColorSpec[\artcolorleft]{HTML}{left}
    \getColorSpec[\artcolorright]{HTML}{right}
    ...
    \node[
        ...
        \includegraphics[width=63mm]{%
            ...
            icons/frame2\pgfkeysifdefined{item}{-heirloom}{}\pgfkeysifdefined{permanent}{-permanent}{}\pgfkeysifdefined{night}{-night}{\pgfkeysifdefined{domain}{-domain}{}}.png
    ...
    \newcommand{\upgradeunderlay}{%
        \begin{tcbclipinterior}
            \node[
                ...
                rounded corners=1mm,
                inner sep=0pt,
                fill=\pgfkeysifdefined{item}{dark!25!heirloomlight!75}{dark!25!light!75},
            ] at (frame.center) {};
        \end{tcbclipinterior}
    }
            ...
            [%
                ...
                underlay={
                    \begin{tcbclipframe}
                        ...
                        % ] at (frame.west) {\includegraphics[height=4mm]{icons/level\pgfkeysifdefined{night}{-night}{}.png}};
                    \end{tcbclipframe}
                },
                left=4.5mm,
            ]
        ...
        \sbox{\rulestextbox}{
            ...
            {%
                ...
                \pgfkeysifdefined{linked}{%
                    ...
                    \pgfkeysifdefined{linked short}{%
                        \textsb{Conjured} (I only join your hand when I'm conjured.)%
                    }{%
                        \textsb{Conjured} (I only join your hand when \pgfkeysvalueof{linked} conjures me.)%
                    }
                    }\par%
                }{}%
    ...
    \pgfkeysifdefined{designer}{%
        \bettertextbox[%
            ...
            x=26.5mm,
            width={30mm}, height=6mm, margin=1mm, 
            anchor=north,
            rotate=-90,
            fontsize=5pt, 
            font=\titlefont,
    ...
    \IfFileExists{\pgfkeysvalueof{/card/art path}}{
        ...
        \node[
            ...
            \includegraphics
                ...
                {%
                    \pgfkeysifdefined{item}{%
                        \getart{\pgfkeysvalueof{/card/art path}}{000000}{000000}
                    }{%
                        \getart{\pgfkeysvalueof{/card/art path}}{\artcolorleft}{\artcolorright}%
                    }%
                }%
        };
    }{%
    ...
    {%
        \pgfkeysifdefined{item}{%
            ...
            \pgfkeysifdefined{domain}{}{\pgfkeysvalueof{/card/path}}%
        }%
    }
    % }%
