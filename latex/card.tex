            ...
            \pgfkeysifdefined{linked}{Conjured Move}{%
                \pgfkeysifdefined{heirloom}{Heirloom}{%
                    \pgfkeysifdefined{token}{Token}{%
                        \pgfkeysifdefined{domain}{Domain}{%
                            \pgfkeysifdefined{primary}{Advanced Move}{Starter Move}%
                        }%
                    }%
                }%
            }%
...
\NewDocumentCommand{\card}{ +O{} }{
    ...
    \node[
        ...
        \includegraphics[width=63mm]{%
            ...
            icons/frame2\pgfkeysifdefined{heirloom}{-heirloom}{}\pgfkeysifdefined{permanent}{-permanent}{}\pgfkeysifdefined{night}{-night}{\pgfkeysifdefined{domain}{-domain}{}}.png
