...
\NewDocumentCommand{\card}{ +O{} }{
    ...
    \pgfkeysifdefined{domain}{%
        \pgfkeys{/card/.cd,
            color-left=\pgfkeysvalueof{/path/color-left},
            color-right=\pgfkeysvalueof{/path/color-right},
        }
