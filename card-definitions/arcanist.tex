...
\card[%
    ...
    cost={F},
    text={%
        Choose \upgrade{two random advanced cards}{one random forbidden magic and one random advanced card} you have not yet learned and recall them. If you recall an innate card, play it immediately.
    },
    upgrade cost={7},
    % upgrade={},
]
