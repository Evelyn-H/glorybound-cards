...
\pgfkeys{/card/.cd,% set the initial path
    ...
    % art path
    art path/.initial={%
        art/\pgfkeysvalueof{/card/path}/\pgfkeysvalueof{/card/name}.png%
    },
}
...
\begin{luacode*}
    function generate_art(folder, name, col1, col2)
        io.popen("cd '"..folder.."' && convert -size $(identify -format %Wx%H '"..name..".png') -define gradient:direction=Northeast gradient:'#"..col1.."'-'#"..col2.."' '"..name..".png' -compose copy_opacity -composite '"..name.."-"..col1.."-"..col2..".png'")
    end
...
\NewDocumentCommand{\card}{ +O{} }{
    ...
    \node[
        ...
        \includegraphics[width=63mm]{%
            % \pgfkeysifdefined{linked}{frame2-gray.png}{frame2.png}
            frame2.png
        }
    };
    ...
    \pgfkeysifdefined{upgrade cost}{%
        ...
        {%
            ...
            % so we can forge all the \upgrade{}{} commands to be executed
        ...
        \sbox{\rulestextbox}{
            ...
            {%
                ...
                \pgfkeysifdefined{linked}{%
                    ...
                    \textsb{Linked} (This card begins the match forgotten and is recalled by \pgfkeysvalueof{linked}.)%
                    }\par%
                }{}%
